	...
	tinymce.html.DomParser = function(settings, schema) {
		...
		self.parse = function(html, args) {
			...
			parser = new tinymce.html.SaxParser({
				...
				// Exclude P and LI from DOM parsing since it's treated better by the DOM parsers
	...
	tinymce.EditorCommands = function(editor) {
		...
		addCommands({
			...
			mceInsertContent : function(command, ui, value) {
				...
				// If parsers says valid we can insert the contents into that parent
				if (!args.invalid) {
					...
					// Get the outer/inner HTML depending on if we are in the root and parsers and serialize that
