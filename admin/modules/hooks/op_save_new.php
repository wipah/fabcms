...
if (!$db->affected_rows) {
  echo 'No data changed';
    ...
    echo $template->getCustomBox( ['class' => 'info', 'title' => 'Hook saved', 'message' => 'Hook saved. <a href="admin.php?module=hook&op=edit&ID=' . $db->insert_id . '">Click here</a> to edit it.'] );
}