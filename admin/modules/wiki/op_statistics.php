...
<nav>
  <div class="nav nav-tabs" id="nav-tab" role="tablist">
    <a class="nav-item nav-link active" id="nav-home-tab" data-bs-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true">Optimizer</a>
    <a class="nav-item nav-link" id="nav-profile-tab" data-bs-toggle="tab" href="#nav-analytics" role="tab" aria-controls="nav-profile" aria-selected="false">Analytics</a>
  </div>
</nav>
