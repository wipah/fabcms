    ...
    ';
            ...
            <div class="content-box">
                <div class="response-msg success ui-corner-all">
                    ...
                    &bull; <a href="admin.php?module=quiz&op=editaDomanda&ID=' . $db->insert_id . '">Modifica la domanda appena inserita
                </div>
            </div>';

            $log->write('quiz_new_question_save_ok','quiz', 'ID: ' . $db->insert_id);
...
<style type="text/css" title="currentStyle">
    @import "' . $URI->getBaseUri(TRUE) . '' . '/> <input id=\"inputPagine_"+ID+"\" type=\"checkbox\" name=\"pagine\" value=\""+ID+"\"/> "+ titolo + "\<\/div><div style=\"both;\">\<\/div>";
